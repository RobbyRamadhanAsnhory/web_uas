...
<html>
  ...
  <body>
    ...
    <div class="edit-login">
        ...
        <hr>
        <form name="formLogin" action="configsql/login.php" method="POST" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                ...
                <input type="password" id="pass" name="pass" class="form-control" placeholder="Silahkan Masukkan Password" maxlength="15" minlength="6">
            </div>
            <button type="submit" class="btn btn-outline-primary my-2 my-sm-0" id="submit" name="submit">Login</button>

...
<html>
  <head>
    ...
    <title>Kontak | Selamat Datang</title>
  </head>
  <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <form class="form-inline my-2 my-lg-0">
                    ...
                    <a class="btn btn-outline-primary my-2 my-sm-0" href="index.php" role="button">Logout</a>
                  </form>
                </div>
              </nav>
          </div>
      ...
      <section class="Jumbotron-bg">
        ...
        <div class="container">
            <h1 class="display-4">Kontak / Hubungi Saya</h1>
                        ...
                        Punya Saran, Pertanyaan, Kritik ataupun Ingin Berbincang ?
                          ...
                          <form>
                            <div class="form-group">
                              ...
                              <small id="emailHelp" class="form-text text-muted">Email Anda Akan Terjaga Dengan Baik Oleh Saya.</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group form-check">
                              ...
                              <label class="form-check-label" for="exampleCheck1">Menyukai Saya </label>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Saran</label>
                                <textarea class="form-control" rows="5" id="exampleFormControlTextarea1" rows="3"></textarea>
                              </div>
